"""
Expression fusion for lazy pandas backends.

This module provides expression fusion capabilities for both backends:

NumExpr (for NumPy arrays)
--------------------------
...
We provide cached function references to reduce Python overhead.
...
Arrow cached evaluation:
    from pandas.lazy.backends.numexpr_fusion import ArrowExprEvaluator

    evaluator = ArrowExprEvaluator()
    result = evaluator.evaluate(ir_node, arrays)
"""
...
def get_arrow_function(func_name: str):
    """
